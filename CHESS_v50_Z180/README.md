...
CHESS v50 Z180 is a two-computer CP/M chess display and self-play project for Small Computer Central Z180 RomWBW systems. One Z180 runs the Black player, the other Z180 runs the White player, and the two machines communicate over Port B using a three-wire null-modem serial link.
