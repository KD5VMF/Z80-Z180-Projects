...
The upstream project identifies itself as BSD licensed. Keep the upstream license terms with redistributed copies of the binary/source.
...
https://github.com/jblang/TMS9918A/tree/master/examples
```
...
Portable_Windows_App/Templates/BALLS.ASM
```
