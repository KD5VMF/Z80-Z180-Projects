...
REV10/REV11 include SC700 helper libraries for the user's current hardware:
...
Build behavior in REV11:
  The IDE copies these libs into a private temporary build folder so sjasmplus can resolve include statements.
  Timestamped public build folders get the generated .ASM, .HEX, and .COM files together.
  Out receives the latest mirror .ASM, .HEX, and .COM for convenience.
