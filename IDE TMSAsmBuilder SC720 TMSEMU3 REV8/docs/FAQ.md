...
So the user controls what is loaded. Click **Load Balls Demo**, **Open ASM**, or **New ASM**.

## Where did the chess demo go?

It was removed. The bundled demo is now `BALLS.ASM`, a colorful TMS9918A/TMSEMU3 sprite demo.
...
The Balls Demo prints an abort message on the CP/M console. Check the video card address/jumpers and make sure the J.B. Langston-style `TmsProbe` routine supports your hardware configuration.
